            ...
            <div class="col-md-2">
                <div class="sidebar" style="height: 100%;">
                    <div class="list-group">
                        ...
                        <a href="tambahproduk.php" class="list-group-item list-group-item-action active">Tambah Produk</a>
                            ...
                            <form method="POST" action="dashboard.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="category" name="category" required>
                                        <option value="Abstrac">Abstrac</option>
                                ...
                                <button type="submit" class="btn btn-primary" name="add_product">Save Produk</button>
                            </form>
                        </div>
                    </div>
                </div>

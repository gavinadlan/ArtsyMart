...
// FECTH PRODUCTS
$sql = "SELECT * from products WHERE category = 'Aesthetic'";
$query = $db->prepare($sql);
$query->execute();
...
<head>
  ...
  <title>ArtsyMart | Aesthetic Collection</title>
...
<body>
  ...
  <section>
    ...
    <div class="container mt-4">
      <h3 class="section-title">Aesthetic Collection</h3>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              <div class="product-card">
                ...
                <div class="card-body">
                  ...
                  <a href="aesthetic.php?add=<?php echo $result->id; ?>" class="btn btn-add-to-cart mt-2">
